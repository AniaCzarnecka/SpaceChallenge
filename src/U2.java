...
public class U2 extends Rocket {
    ...
    private final int maxCargo = 29000;
    ...
    public static int getRocketU2Counter(){return rocketU2Counter;}
    public static void setRocketU2Counter(int rocketU2Counter){U2.rocketU2Counter = rocketU2Counter;}
    ...
    public static long getTotalCost(){return (long) getRocketU2Counter() * cost;}
